...
#' @param filmDistortionInformationAvailability Code which indicates whether or not Calibration Reseau information is available See [filmDistortionInformationAvailability()]
#' @param lensDistortionInformationAvailability Code which indicates whether or not lens aberration correction information is available See [lensDistortionInformationAvailability()]
