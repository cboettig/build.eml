...
#' @param attributeName The name of the attribute See [attributeName()]
#' @param attributeLabel A label for displaying an attribute name. See [attributeLabel()]
#' @param attributeDefinition Precise definition of the attribute See [attributeDefinition()]
#' @param storageType Storage type hint for this field See [storageType()]
#' @param measurementScale The measurement scale for the attribute. See [measurementScale()]
#' @param missingValueCode Character for missing value in the data of the field See [missingValueCode()]
